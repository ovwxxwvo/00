...
# get var
  ...
  cmd=$( \
    ps -o comm= -t $pts \
    | grep -Ev "xclip|file|tail|ueberzug" \
    | tail -n 1 \
    )
...
# set, sh | ra | vi , in different color
  if   [[ $cmd =~ nvim ]]; then
    ...
    color_status="fg=#a0ffd0,bg=#002010"
    color_stalft="fg=#a0ffd0,bg=#002010"
    color_starft="fg=#a0ffd0,bg=#002010"
    color_stawnf="fg=#60a080,bg=#002010"
    color_stawfc="fg=#50b080,bg=#002010"
  elif [[ $cmd =~ josh ]]; then
    color_window="fg=#5080b0,bg=#0d141a"
    color_border="fg=#3080d0,bg=#001020"
    color_status="fg=#a0d0ff,bg=#001020"
    color_stalft="fg=#a0d0ff,bg=#001020"
    color_starft="fg=#a0d0ff,bg=#001020"
    color_stawnf="fg=#6080a0,bg=#001020"
    color_stawfc="fg=#5080b0,bg=#001020"
  elif [[ $cmd =~ fish ]]; then
    color_window="fg=#b08050,bg=#1a140d"
    color_border="fg=#d08030,bg=#201000"
    color_status="fg=#ffd0a0,bg=#201000"
    color_stalft="fg=#ffd0a0,bg=#201000"
    color_starft="fg=#ffd0a0,bg=#201000"
    color_stawnf="fg=#a08060,bg=#201000"
    color_stawfc="fg=#b08050,bg=#201000"
  else
    color_window="fg=#b0b0b0,bg=#101010"
    color_border="fg=#d0d0d0,bg=#101010"
    color_status="fg=#d0d0d0,bg=#101010"
    color_stalft="fg=#d0d0d0,bg=#101010"
