...
local function setup(st, opts)
  ...
  local git_deleted_fg   = t.deleted_fg   or "#ff4500"
  local git_updated_fg   = t.updated_fg   or "#1e90ff"
  local git_ignored_fg   = t.ignored_fg   or "#696969"
  local git_untracked_fg = t.untracked_fg or "#a9a9a9"
    -- local git_modified_fg
    -- local git_added_fg
    -- local git_deleted_fg
    -- local git_updated_fg
    -- local git_ignored_fg
    -- local git_untracked_fg

	local styles = {
		[6] = t.modified  and ui.Style(t.modified)  or ui.Style():fg(git_modified_fg ),
		[5] = t.added     and ui.Style(t.added)     or ui.Style():fg(git_added_fg    ),
		[2] = t.deleted   and ui.Style(t.deleted)   or ui.Style():fg(git_deleted_fg  ),
		[1] = t.updated   and ui.Style(t.updated)   or ui.Style():fg(git_updated_fg  ),
		[3] = t.ignored   and ui.Style(t.ignored)   or ui.Style():fg(git_ignored_fg  ),
		[4] = t.untracked and ui.Style(t.untracked) or ui.Style():fg(git_untracked_fg),
