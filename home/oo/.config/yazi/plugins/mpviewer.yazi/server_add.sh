...
# echo '{ "command": [ "", ""] }' |socat - /tmp/mpv_fifo
# echo '{ "command": ["playlist-next", "force"] }' |socat - /tmp/mpv_fifo
# echo '{ "command": [ "loadfile", "/0000/HH¦DATA/22_photo/01_wallpaper/vivian_00.jpg"] }' |socat - /tmp/mpv_fifo
echo '{ "command": [ "loadfile", "/0000/HH¦DATA/23_music/music_00/Beyond -  海阔天空(Live93).mp3"] }' |socat - /tmp/mpv_fifo
# echo '{ "command": [ "geometry", "1920"] }' |socat - /tmp/mpv_fifo


# swaymsg  [app_id="mpv"] move position center; swaymsg  [app_id="mpv"] resize set 50ppt 50ppt
# swaymsg  [title="mpv_server"] move position center
swaymsg  [title="mpv_server"] resize set 10ppt 10ppt
swaymsg  [title="mpv_server"] resize set 80ppt 80ppt
swaymsg  [title="mpv_server"] move position 100 100
